...
var snakeGame = (function () {
    ...
    var GameObject = Class.create({
        ...
        intersects: function (other) {
            ...
            var otherInThisX = (thisLeft < otherLeft && otherLeft <= thisRight) ||
                (thisLeft <= otherLeft && otherLeft < thisRight) ||
                (thisLeft < otherRight && otherRight <= thisRight) ||
                (thisLeft <= otherRight && otherRight < thisRight);
            var otherInThisY = (thisTop < otherTop && otherTop <= thisBottom) ||
                (thisTop <= otherBottom && otherBottom < thisBottom) ||
                (thisTop < otherTop && otherTop <= thisBottom) ||
                (thisTop <= otherBottom && otherBottom < thisBottom);
            var thisInOtherX = (otherLeft < thisLeft && thisLeft <= otherRight) ||
                (otherLeft <= thisRight && thisRight < otherRight) ||
                (otherLeft < thisLeft && thisLeft <= otherRight) ||
                (otherLeft <= thisRight && thisRight < otherRight);
            var thisInOtherY = (otherTop < thisTop && thisTop <= otherBottom) ||
                (otherTop <= thisBottom && thisBottom < otherBottom) ||
                (otherTop < thisTop && thisTop <= otherBottom) ||
                (otherTop <= thisBottom && thisBottom < otherBottom);
